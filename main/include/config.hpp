...
namespace espConfig
{
  ...
  struct misc_config_t
  {
    ...
    // Xiaomi lock, reached locally over miIO (UDP 54321). Filled by the
    // web portal after a Xiaomi account login, or by hand.
    std::string xiaomiLockIp = "";
    std::string xiaomiLockToken = "";
    std::string xiaomiLockDid = "";
    uint8_t xiaomiUnlatchAiid = 4;  // 4 = emergency-unlock (unlatch), 9 = ble-unlock
  };
